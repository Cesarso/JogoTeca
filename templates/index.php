...
?>
      ...
      <section class="section swiper-container swiper-slider swiper-slider-modern" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="true" data-slide-effect="fade">
        <div class="swiper-wrapper text-left">
          <div class="swiper-slide context-dark" data-slide-bg="images/banner/images1.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-center justify-content-xxl-start">
                  <div class="col-md-10 col-xxl-6">
                    <div class="slider-modern-box">
                      <h1 class="slider-modern-title"><span data-caption-animate="slideInDown" data-caption-delay="0">Doces</span></h1>
                      <p data-caption-animate="fadeInRight" data-caption-delay="400">Venha conhecer nossos Doces artesanais, os melhores da região!</p>
          ...
          <div class="swiper-slide context-dark" data-slide-bg="images/banner/999.jpg">
            <div class="swiper-slide-caption">
              <div class="container">
                <div class="row justify-content-center justify-content-xxl-start">
                  <div class="col-md-10 col-xxl-6">
                    <div class="slider-modern-box">
                      <h1 class="slider-modern-title"><span data-caption-animate="slideInLeft" data-caption-delay="0">Bolos</span></h1>
                      <p data-caption-animate="fadeInRight" data-caption-delay="400">Expiremente nossos Coppcakes, temos vários sabores, você também pode recheá-los como preferir!!</p>
                      <div class="oh button-wrap"><a class="button button-primary button-ujarak" href="about-us.html" data-caption-animate="slideInLeft" data-caption-delay="400">Veja Mais</a></div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-6 col-lg-4 wow fadeInRight" data-wow-delay=".1s">
              <article class="box-icon-ruby">
                <div class="unit box-icon-ruby-body flex-column flex-md-row text-md-left flex-lg-column align-items-center text-lg-center flex-xl-row text-xl-left">
                  ...
                  <div class="unit-body">
                    <h4 class="box-icon-ruby-title"><a href="#">Bolos e Doces</a></h4>
                  </div>
                </div>
              </article>
            </div>
